...
class SubscriptionsApi
{
    ...
    {
        $this->cancelSubscriptionWithHttpInfo($body, $subscription_id);
    }
     ...
     */
    public function createSubscription($body, $customer_id)
    {
        list($response) = $this->createSubscriptionWithHttpInfo($body, $customer_id);
        return $response;
    }
     ...
     */
    public function createSubscriptionWithHttpInfo($body, $customer_id)
    {
        $returnType = '\BillaBear\Model\Subscription';
        $request = $this->createSubscriptionRequest($body, $customer_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSubscriptionAsync($body, $customer_id)
    {
        return $this->createSubscriptionAsyncWithHttpInfo($body, $customer_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSubscriptionAsyncWithHttpInfo($body, $customer_id)
    {
        $returnType = '\BillaBear\Model\Subscription';
        $request = $this->createSubscriptionRequest($body, $customer_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createSubscriptionRequest($body, $customer_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $customer_id when calling createSubscription'
            );
        }
