...
class PaymentDetailsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\FrontendToken $body body (required)
     ...
     * Complete Frontend Detail Collection
     *
     * @param  \Swagger\Client\Model\FrontendToken $body (required)
     * @param  string $customer_id The id of the customer to retrieve (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PaymentDetails, HTTP status code, HTTP response headers (array of strings)
     */
    public function completeFrontendPaymentDetailsWithHttpInfo($body, $customer_id)
    {
        $returnType = '\Swagger\Client\Model\PaymentDetails';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PaymentDetails',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\FrontendToken
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\FrontendToken, HTTP status code, HTTP response headers (array of strings)
     */
    public function startFrontendPaymentDetailsWithHttpInfo($customer_id)
    {
        $returnType = '\Swagger\Client\Model\FrontendToken';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\FrontendToken',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
