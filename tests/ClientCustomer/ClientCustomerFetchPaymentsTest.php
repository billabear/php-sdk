...
class ClientCustomerFetchPaymentsTest extends TestCase
{
    public function testFetchCustomerPaymentsNotFound()
    {
    ...
    public function testFetchCustomerPaymentsUnexpectedResponse()
    {
    ...
    public function testFetchCustomerPaymentsValid()
    {
        $requestSender = $this->createMock(RequestSenderInterface::class);
        $expected = [
            'data' => [],
