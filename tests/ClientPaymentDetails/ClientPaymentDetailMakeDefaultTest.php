...
class ClientPaymentDetailMakeDefaultTest extends TestCase
{
    public function testMakeDefaultNotFound()
    {
        ...
        $requestSender->expects($this->once())->method('send')->with('POST', '/v1/customer/id-here/payment-methods/second-id-here/default')->willReturn($response);

        $client = new Client($requestSender);
        $client->makePaymentDetailsDefault('id-here', 'second-id-here');
    }

    public function testMakeDefaultUnexpectedResponse()
    {
